...
export class Configuration {
  ...
  constructor() {
    ...
    this.defaultServerDir = vscode.Uri.joinPath(
    ...
    this.defaultServerPath = vscode.Uri.joinPath(
      this.defaultServerDir,
      this.serverName
    );
  }
  ...
  get serverPath(): string {
    const serverPath =
      this.configuration.get<string | null>(SERVER_PATH_OPT) ??
      this.defaultServerPath.fsPath;
  ...
  get suiPath(): string {
    ...
    const suiPath =
      this.configuration.get<string | null>(SUI_PATH_OPT) ?? suiBin;
