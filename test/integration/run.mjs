...
const semanticCases = [
  ...
  "wasm-loader-resilience",
  "reference-artifact-inspect",
  "bytecode-verifiers-manifest",
  "output-deps",
...
const caseFiles = new Map([
  ...
  ["wasm-loader-resilience", "wasm_loader_resilience_test.mjs"],
  ["reference-artifact-inspect", "reference_artifact_inspect_test.mjs"],
  ["bytecode-verifiers-manifest", "bytecode_verifiers_manifest_test.mjs"],
