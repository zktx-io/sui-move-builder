...
| Mode filtering/linkage          | `external-crates/move/crates/move-package-alt/src/graph/linkage.rs`                                                                                  | `sui-move-wasm/src/lockfile_v4/mod.rs`, `sui-move-wasm/src/manifest_graph.rs`                                             | rust self-impl      | Lockfile graph, build-options, stage-observability, and parity tests    | Re-check mode-gated edges, override conflicts, original-ID selection, and cycles.                     |
