...
| Manifest graph                  | `external-crates/move/crates/move-package-alt/src/graph/builder.rs`                                                                                  | `sui-move-wasm/src/lib.rs`                                 | rust self-impl      | Manifest fallback, package-loading, and stage-observability tests       | Re-check package ID creation, dependency merge, local dependencies, and cycles.                       |
| V4 graph                        | `external-crates/move/crates/move-package-alt/src/graph/builder.rs`                                                                                  | `sui-move-wasm/src/lib.rs`                                 | rust self-impl      | Lockfile graph and stage-observability tests                            | Re-check pin fetch plan, manifest digest, override edges, and undefined edges.                        |
| Mode filtering/linkage          | `external-crates/move/crates/move-package-alt/src/graph/linkage.rs`                                                                                  | `sui-move-wasm/src/lib.rs`                                 | rust self-impl      | Lockfile graph, build-options, stage-observability, and parity tests    | Re-check mode-gated edges, override conflicts, original-ID selection, and cycles.                     |
