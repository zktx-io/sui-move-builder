...
| `Move.toml`/env overlay         | `external-crates/move/crates/move-package-alt/src/package/package_impl.rs`, `crates/sui-package-alt/src/sui_flavor.rs`                               | `sui-move-wasm/src/manifest_digest.rs`, `sui-move-wasm/src/lockfile_v4/mod.rs`, `sui-move-wasm/src/manifest_graph.rs` | rust self-impl      | Manifest digest, manifest fallback, build-options tests                 | Re-check manifest parser fields, implicit deps, environment overlays, modes.                          |
...
| Manifest digest                 | `external-crates/move/crates/move-package-alt/src/package/package_impl.rs`, `external-crates/move/crates/move-package-alt/src/dependency/combine.rs` | `sui-move-wasm/src/manifest_digest.rs`                                                                                | rust self-impl      | Manifest digest and manifest digest CLI parity tests                    | Re-check `CombinedDependency`, `ReplacementDependency`, implicit deps, and TOML.                      |
