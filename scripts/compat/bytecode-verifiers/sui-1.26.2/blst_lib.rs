...
pub fn blst_scalar_fr_check(_: *const blst_scalar) -> bool {
    true
}
...
impl blst_fp12 {
    ...
    pub fn final_exp(&mut self) -> blst_fp12 {
        blst_fp12::default()
    }
...
static ONE: blst_fp12 = blst_fp12 {
    fp6: [blst_fp6 {
        fp2: [blst_fp2 {
            fp: [blst_fp { l: [0; 6] }; 2],
        }; 3],
...
impl blst_p1 {
    ...
    pub fn hash_to(_: &[u8], _: &[u8], _: &[u8]) -> Self {
        Self::default()
    }
    pub fn from_affine(_: &blst_p1_affine) -> Self {
        Self::default()
    }
}
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
...
impl blst_p1_affine {
    pub fn from_compress(_: &[u8]) -> Result<Self, BLST_ERROR> {
        Ok(Self::default())
    }
    pub fn serialize(&self) -> [u8; 48] {
        [0; 48]
...
pub fn blst_p1_uncompress(_: *mut blst_p1_affine, _: *const u8) -> BLST_ERROR {
    BLST_ERROR::BLST_SUCCESS
}
pub fn blst_p1_deserialize(_: *mut blst_p1_affine, _: *const u8) -> BLST_ERROR {
    BLST_ERROR::BLST_SUCCESS
}
...
pub fn blst_p1_in_g1(_: *const blst_p1) -> bool {
    true
}
...
impl blst_p2 {
    ...
    pub fn from_affine(_: &blst_p2_affine) -> Self {
        Self::default()
    }
}
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
...
pub fn blst_p2_uncompress(_: *mut blst_p2_affine, _: *const u8) -> BLST_ERROR {
    BLST_ERROR::BLST_SUCCESS
}
...
pub fn blst_p2_in_g2(_: *const blst_p2) -> bool {
    true
}
...
impl Pairing {
    ...
    pub fn as_fp12(&self) -> blst_fp12 {
        blst_fp12::default()
    }
    pub fn commit(&mut self) {}
    pub fn final_exp(&self) -> blst_fp12 {
        blst_fp12::default()
    }
    pub fn mul_n_exp(_: &blst_fp12) -> bool {
        true
    }
}
...
impl From<&[blst_p1_affine]> for p1_affines {
    fn from(_: &[blst_p1_affine]) -> Self {
        Self
    }
}
impl p1_affines {
    pub fn mult<A, B>(&self, _: A, _: B) -> blst_p1 {
        blst_p1::default()
    }
}

pub struct p2_affines;
impl From<&[blst_p2_affine]> for p2_affines {
    fn from(_: &[blst_p2_affine]) -> Self {
        Self
    }
}
impl p2_affines {
    pub fn mult<A, B>(&self, _: A, _: B) -> blst_p2 {
        blst_p2::default()
    }
}
...
pub mod min_pk {
    ...
    impl SecretKey {
        pub fn from_bytes(_: &[u8]) -> Result<Self, BLST_ERROR> {
            Ok(Self::default())
        }
        pub fn to_bytes(&self) -> [u8; 32] {
            [0; 32]
        }
        pub fn key_gen(_: &[u8], _: &[u8]) -> Result<Self, BLST_ERROR> {
            Ok(Self::default())
        }
        pub fn key_gen_v3(_: &[u8], _: &[u8]) -> Result<Self, BLST_ERROR> {
            Ok(Self::default())
        }
        pub fn key_gen_v4_5(_: &[u8], _: &[u8], _: &[u8]) -> Result<Self, BLST_ERROR> {
            Ok(Self::default())
        }
        pub fn sk_to_pk(&self) -> PublicKey {
            PublicKey::default()
        }
        pub fn sign(&self, _: &[u8], _: &[u8], _: &[u8]) -> Signature {
            Signature::default()
        }
    }
    ...
    impl AggregateSignature {
        ...
        pub fn aggregate(_: &[&Signature], _: bool) -> Result<Self, BLST_ERROR> {
            Ok(Self::default())
        }
        pub fn add_signature(&mut self, _: &Signature, _: bool) -> Result<(), BLST_ERROR> {
            Ok(())
        }
    ...
    impl AggregatePublicKey {
        pub fn from_public_keys(_: &[&PublicKey]) -> Result<Self, BLST_ERROR> {
            Ok(Self::default())
        }
        pub fn to_public_key(&self) -> PublicKey {
            PublicKey::default()
        }
        pub fn aggregate(_: &[&PublicKey], _: bool) -> Result<Self, BLST_ERROR> {
            Ok(Self::default())
        }
    }
}
